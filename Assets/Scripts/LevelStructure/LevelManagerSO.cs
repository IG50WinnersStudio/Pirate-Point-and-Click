...
[CreateAssetMenu(fileName = "NewLevelManager", menuName = "Scriptable Objects/Scene Data/Manager")]
public class LevelManagerSO : ScriptableObject
{
    ...
    {
        SceneManager.LoadSceneAsync(menus[(int)Type.Highscore_Menu].SceneName);
    }

    // Load Sound Menu
    public void LoadSoundMenu()
    {
        SceneManager.LoadSceneAsync(menus[(int)Type.Sound_Menu].SceneName);
    }

    // Load Info Menu
    public void LoadInfoMenu()
    {
        SceneManager.LoadSceneAsync(menus[(int)Type.Info_Menu].SceneName);
    }
